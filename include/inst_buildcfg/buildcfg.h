...
#ifdef KNSD_INSTALLER
#pragma message("\t    KNSD_INSTALLER")
#define VI_FILEDESCRIPTION	"金山卫士在线安装器"
#define VI_INTERNALNAME		"ksafeinst"
#define VI_ORIGINALFILENAME	"ksafeinst.exe"
#endif
