...
; 安装程序初始定义常量
!define PRODUCT_NAME "金山卫士垃圾清理引擎"
!define PRODUCT_PUBLISHER "金山卫士垃圾清理引擎"
!define PRODUCT_WEB_SITE "http://www.ijinshan.com"
!define PRODUCT_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}"
!define PRODUCT_UNINST_ROOT_KEY "HKLM"
!define PRODUCT_VERSION "1.0 Beta版"
!define PRODUCT_ENG_MARK  "SOFTWARE\KSafe\KClear"
...
InstallDir "$PROGRAMFILES\KSafe\KClear"
XPStyle on
...
!include "kclear_install_mainsection.nsh"

Section -Post
  WriteUninstaller "$INSTDIR\uninstclear.exe"
SectionEnd
...
Section Uninstall
  ...
  !insertmacro DeleteFileEx "$INSTDIR\KClear.exe" "$INSTDIR"

  Delete /REBOOTOK "$INSTDIR\uninstclear.exe"
...
VIAddVersionKey  "ProductName" "金山卫士垃圾清理引擎"
VIAddVersionKey  "Comments" "金山卫士垃圾清理引擎"
VIAddVersionKey  "CompanyName" "金山卫士"
VIAddVersionKey  "LegalTrademarks" "金山卫士"
VIAddVersionKey  "LegalCopyright" "版权所有(C) 2010 金山卫士"
VIAddVersionKey  "FileDescription" "金山卫士垃圾清理引擎"
