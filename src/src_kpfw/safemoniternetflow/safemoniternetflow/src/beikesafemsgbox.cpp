...
LRESULT CBkSafeMsgBox::OnInitDialog(HWND hWnd, LPARAM lParam)
{
	...
	rcClient.right = rcClient.left + max(max(rcCaption.right, rcText.right), m_width);
    rcClient.bottom = rcClient.top + max(rcText.bottom, m_height);
...
UINT_PTR CBkSafeMsgBoxDriverFailed::ShowMsg( LPCWSTR lpszText, LPCWSTR lpszCaption /*= NULL*/, LPCWSTR lpszCheckCaption /*= NULL*/, UINT uType /*= MB_OK*/, BOOL *pbNoNotifyLater /*= NULL*/, HWND hWndParent /*= NULL*/ )
{
	if (!Load(IDR_BK_MESSAGEBOX_DRIVER_FAIL))
		return -1;
...
void CBkSafeMsgBoxDriverFailed::_InitLayout( BOOL * pbNoNotifyLater )
{
	CString strButtonXmlFormat, strButtons, strButtonDiv;

	AddButton(BkString::Get(45), ID_BUTTON_OEPNNOW);
	AddButton(BkString::Get(319), ID_BUTTON_CANCEL);
...
//////////////////////////////////////////////////////////////////////////
UINT_PTR CBkSafeMsgBoxForceDisableTDI::ShowMsg( LPCWSTR lpszText, LPCWSTR lpszCaption /*= NULL*/, LPCWSTR lpszCheckCaption /*= NULL*/, UINT uType /*= MB_OK*/, BOOL *pbNoNotifyLater /*= NULL*/, HWND hWndParent /*= NULL*/ )
{
	if (!Load(IDR_BK_MESSAGEBOX_FLUX_DISABLE_BY_CLOUD))
		return -1;
...
void CBkSafeMsgBoxForceDisableTDI::_InitLayout( BOOL * pbNoNotifyLater )
{
	CString strButtonXmlFormat, strButtons, strButtonDiv;

	AddButton(BkString::Get(42), ID_BUTTON_FEEDBACK);
	AddButton(BkString::Get(43), ID_BUTTON_QUIT);
...
//////////////////////////////////////////////////////////////////////////
UINT_PTR CBkSafeMsgBoxFindUnCompatibleDriver::ShowMsg( LPCWSTR lpszText, LPCWSTR lpszCaption /*= NULL*/, LPCWSTR lpszCheckCaption /*= NULL*/, UINT uType /*= MB_OK*/, BOOL *pbNoNotifyLater /*= NULL*/, HWND hWndParent /*= NULL*/ )
{
	if (!Load(IDR_BK_MESSAGEBOX_FIND_UNCOMPATIBLE_DRIVER))
		return -1;
...
void CBkSafeMsgBoxFindUnCompatibleDriver::_InitLayout( BOOL * pbNoNotifyLater )
{
	CString strButtonXmlFormat, strButtons, strButtonDiv;
...
//////////////////////////////////////////////////////////////////////////
UINT_PTR CBkSafeMsgBoxFindNoTdxDriver::ShowMsg( LPCWSTR lpszText, LPCWSTR lpszCaption /*= NULL*/, LPCWSTR lpszCheckCaption /*= NULL*/, UINT uType /*= MB_OK*/, BOOL *pbNoNotifyLater /*= NULL*/, HWND hWndParent /*= NULL*/ )
{
	if (!Load(IDR_BK_MESSAGEBOX_FIND_NO_TDX_DRIVER))
		return -1;
...
void CBkSafeMsgBoxFindNoTdxDriver::_InitLayout( BOOL * pbNoNotifyLater )
{
	CString strButtonXmlFormat, strButtons, strButtonDiv;
...
void CBkSafeMsgBoxFindUnCompatibleSoftware::_InitLayout( BOOL * pbNoNotifyLater )
{
	CString strButtonXmlFormat, strButtons, strButtonDiv;
...
//////////////////////////////////////////////////////////////////////////
UINT_PTR CBkSafeMsgBoxFindDriverVersionError::ShowMsg( LPCWSTR lpszText, LPCWSTR lpszCaption /*= NULL*/, LPCWSTR lpszCheckCaption /*= NULL*/, UINT uType /*= MB_OK*/, BOOL *pbNoNotifyLater /*= NULL*/, HWND hWndParent /*= NULL*/ )
{
	if (!Load(IDR_BK_MESSAGEBOX_FIND_DRIVER_VERSION_ERRRO))
		return -1;
...
void CBkSafeMsgBoxFindDriverVersionError::_InitLayout( BOOL * pbNoNotifyLater )
{
	CString strButtonXmlFormat, strButtons, strButtonDiv;

	AddButton(BkString::Get(47), ID_BUTTON_REBOOTNOW);
	AddButton(BkString::Get(48), ID_BUTTON_REBOOTLATER);
