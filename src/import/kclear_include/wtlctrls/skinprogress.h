...
class CSkinProgress;
typedef CWindowImpl<CSkinProgress, CStatic> SKIN_PROGRESS_BASE;

//////////////////////////////////////////////////////////////////////////

class CSkinProgress : public SKIN_PROGRESS_BASE
{
public:
	DECLARE_WND_SUPERCLASS(0, GetWndClassName())

	BEGIN_MSG_MAP(CSkinProgress)
