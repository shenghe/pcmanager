...
{
public:
	CDataObjectEx( CDropSourceEx *pDropSource )
	{
		m_nRefCount = 0;
...
template < class T >
class CDataObjectExT : public CDataObjectEx
{
public:
	CDataObjectExT( CDropSourceEx *pDropSource ) : CDataObjectEx( pDropSource )
	{
		m_pDelegate = FALSE;
	}
