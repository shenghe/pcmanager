...
typedef 
enum tagINET_FW_EDGE_TRAVERSAL_TYPE
    {	INET_FW_EDGE_TRAVERSAL_TYPE_DENY	= 0,
	INET_FW_EDGE_TRAVERSAL_TYPE_ALLOW	= ( INET_FW_EDGE_TRAVERSAL_TYPE_DENY + 1 ) ,
	INET_FW_EDGE_TRAVERSAL_TYPE_DEFER_TO_APP	= ( INET_FW_EDGE_TRAVERSAL_TYPE_ALLOW + 1 ) ,
	INET_FW_EDGE_TRAVERSAL_TYPE_DEFER_TO_USER	= ( INET_FW_EDGE_TRAVERSAL_TYPE_DEFER_TO_APP + 1 ) 
    } 	INET_FW_EDGE_TRAVERSAL_TYPE;
